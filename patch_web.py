...
# 1. Update navigation menu across templates
nav_links_dashboard = '''<div class="nav-pills">
    <a href="/">Главная</a>
...
nav_links_dashboard_active = '''<div class="nav-pills">
    <a href="/">Главная</a>
    <a href="/stats">Вчерашняя</a>
    <a href="/weekly">Еженедельная</a>
...
if '<a href="/dashboard" class="active">Дашборд</a>' in content:
    content = content.replace(
        '<a href="/dashboard" class="active">Дашборд</a>',
        '<a href="/dashboard" class="active">Дашборд</a>\n    <a href="/bots">🤖 Боты</a>'
    )

# 2. Add /bots templates and routes
bot_code = '''
# --- BOTS UI ---
...
if "# --- BOTS UI ---" not in content:
    content = content.replace("# --- планировщик", bot_code + "\n# --- планировщик")

# add pill to index
if '<a href="/create" style="text-decoration:none"><button class=btngreen>➕ Создать объявление</button></a>' in content:
    content = content.replace(
